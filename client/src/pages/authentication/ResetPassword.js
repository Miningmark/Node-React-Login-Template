...
function ResetPassword() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            addToast(error.response?.data?.message || "Serverfehler beim Zurücksetzen des Passworts", "danger");
        }
    };
            ...
            >
                ...
                <Form onSubmit={handleSubmit} noValidate>
                    ...
                    <div className="form-floating mb-3">
                        <input
                            type="password"
                            className={`form-control ${touched.repeat && !passwordsMatch ? "is-invalid" : passwordsMatch && repeatPassword !== "" ? "is-valid" : ""}`}
