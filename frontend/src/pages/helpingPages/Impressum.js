function Impressum() {
  return (
    <div className="container mt-5 mb-5">
      ...
      <p>
        § 1 Haftungsbeschränkung <br /> Die Inhalte dieser Website werden mit größtmöglicher
        Sorgfalt erstellt. Der Anbieter übernimmt jedoch keine Gewähr für die Richtigkeit,
        Vollständigkeit und Aktualität der bereitgestellten Inhalte. Die Nutzung der Inhalte der
        Website erfolgt auf eigene Gefahr des Nutzers. Namentlich gekennzeichnete Beiträge geben die
        Meinung des jeweiligen Autors und nicht immer die Meinung des Anbieters wieder. Mit der
        reinen Nutzung der Website des Anbieters kommt keinerlei Vertragsverhältnis zwischen dem
        Nutzer und dem Anbieter zustande.
      </p>
      <p>
        § 2 Externe Links
        <br /> Diese Website enthält Verknüpfungen zu Websites Dritter („externe Links“). Diese
      ...
      <p>
        ...
        <br /> Die auf dieser Website veröffentlichten Inhalte unterliegen dem deutschen Urheber-
