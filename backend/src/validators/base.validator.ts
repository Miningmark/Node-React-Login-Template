...
export const usernameBaseValidation: ZodString = z.string().min(5).max(15).regex(USERNAME_REGEX, "Benutzername entspricht nicht den Anforderungen");
export const emailBaseValidation: ZodString = z.string().regex(EMAIL_REGEX, "Email entspricht nicht den Anforderungen");
